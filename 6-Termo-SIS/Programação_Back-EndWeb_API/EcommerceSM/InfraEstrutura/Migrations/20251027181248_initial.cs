        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnidadeCompra = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    Estoque = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pedidos_FormaPagamentos_IdFormaPagamento",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProdutoPedidos_Pedidos_IdPedido",
                        column: x => x.IdPedido,
                        principalTable: "Pedidos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProdutoPedidos_Produtos_IdProduto",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProdutoPedidos_IdPedido",
                table: "ProdutoPedidos",
                column: "IdPedido");

            migrationBuilder.CreateIndex(
                name: "IX_ProdutoPedidos_IdProduto",
                table: "ProdutoPedidos",
                column: "IdProduto");
